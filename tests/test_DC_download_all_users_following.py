...
def test_save_content(mock_file):
    ...
    mock_file.assert_called_once_with(os.path.join(OUTPUT_DIR, filename), 'w', encoding='utf-8')
...
def test_process_url(mock_save_content, mock_download_page, mock_setup_selenium):
    ...
    mock_save_content.assert_called_once_with("<html>Test Content</html>", 'example.com.html')
