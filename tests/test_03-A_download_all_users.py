...
def test_setup_selenium():
    with patch('selenium.webdriver.Chrome') as mock_chrome:
        ...
        from 03-A_download_all_users import setup_selenium
...
def test_login_to_kiwifarms(mock_driver):
    with patch('03-A_download_all_users.BeautifulSoup') as mock_bs, \
        ...
        from 03-A_download_all_users import login_to_kiwifarms
...
def test_download_member_pages(mock_driver):
    with patch('builtins.open', new_callable=MagicMock) as mock_open, \
         patch('03-A_download_all_users.logger') as mock_logger:
        from 03-A_download_all_users import download_member_pages
        ...
        mock_logger.info.assert_any_call(f"Successfully downloaded {test_urls[0]}")
