...
GIT_REPO_URL = "https://github.com/Nick2bad4u/Kiwifarmer"
# Output file name
...
second_folder = []
third_folder = []
file_extension_top_folder_ext = ".py"
file_extension_top_folder_name = "<h2>Py</h2>"
file_extension_second_folder_ext = ".json"
file_extension_second_folder_name = "<h2>JSON</h2>"
